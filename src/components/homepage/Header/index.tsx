    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
            ENCONTRE ROUPAS PARA FICAR IGUAL O ARTHUR
          </motion.h2>
          <motion.p
          ...
          >
            Navegue pela nossa diversificada gama de roupas meticulosamente elaboradas,
            projetado para realçar sua arthualidade e atender ao seu senso de
            estilo.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
          ...
          >
            <Link
              href="/shop"
              className="w-full md:w-52 mb-5 md:mb-12 inline-block text-center bg-black hover:bg-black/80 transition-all text-white px-12 py-4 rounded-full hover:animate-pulse"
            >
              Compre Agora
            </Link>
          </motion.div>
          ...
          >
            <div className="flex flex-col">
              <span className="font-bold text-2xl md:text-xl lg:text-3xl xl:text-[36px] xl:mb-2">
        ...
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_4rem] bg-no-repeat bg-[url('/images/header-res-homepage.png')] md:bg-[url('/images/header-homepage.png')]"
        >
          <Image
            priority
